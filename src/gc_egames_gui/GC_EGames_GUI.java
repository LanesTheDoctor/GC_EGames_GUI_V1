/*
   ...
   Purpose: 
        ...
        2. Program usess DB_Read and DB_Write classes to connect to the SQL database to run SQL statements for the purpose of sending and retrieving data. 
   Author: Zac Makkinga
   Date: 06/05/2025
   Version: 1.0
...
public class GC_EGames_GUI extends javax.swing.JFrame 
{
        ...
        */
        ...
        if (dbRead.getRecordCount() > 0)
        {
            ...
            for (int i = 0; i < eventsCSVStrArray.length; i++) 
            {
                ...
                event_JComboBox.addItem(eventName);
    ...
    */
    ...
    private void event_JComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_event_JComboBoxItemStateChanged
        ...
        {
            Object selectedObj = event_JComboBox.getSelectedItem();
            if (selectedObj == null) 
            {
            ...
            String selectedEvent = selectedObj.toString();
            // Now it is SAFE to use selectedEvent in your logic
    ...
    private void addNewCompResult_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewCompResult_JButtonActionPerformed
        ...
        Object newCompResultEvent = addNewCompResultEvent_JComboBox.getSelectedItem();
        Object newCompResultGame = addNewCompResultGame_JComboBox.getSelectedItem();
        Object newCompResultTeam1 = addNewCompResultTeam1_JComboBox.getSelectedItem();
        Object newCompResultTeam2 = addNewCompResultTeam2_JComboBox.getSelectedItem();
        Object newCompResultTeam1Points = addNewCompResultTeam1Points_JTextField.getText();
        Object newCompResultTeam2Points = addNewCompResultTeam2Points_JTextField.getText();
